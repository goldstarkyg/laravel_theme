...
$(document).ready(function() {
    ...
    $(".navbar-fixed-header .toggle-right,.navbar-fixed-heade .toggle-left").on('click',function () {
        $('#top').toggleClass('fixednav')
    })

    $(".navbar-fixed-header .toggle-left").on('click',function () {
