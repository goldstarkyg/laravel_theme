...
var paths = {
    ...
    'jquery_tagsinput': vendors + 'jquery-tags-input/src/',
    'bootstrap_timepicker': vendors + 'bootstrap-timepicker/',
    'boostrap3_wysihtml5': bowervendors + 'bootstrap3-wysihtml5-bower/dist/',
    ...
    'gmaps': vendors + 'gmaps/',
    'handlebars': bowervendors + 'handlebars/',
    ...
    'validval': bowervendors + 'jQuery.validVal/',
    ...
    'inputmask': bowervendors + 'jquery.inputmask/dist/',
...
elixir(function(mix) {
    ...
    // jquery.backstretch
    mix.copy(paths.backstretch + 'jquery.backstretch.js', destVendors + 'jquerybackstretch/js');
    ...
    mix.scripts(
        [
            ...
            '../../vendors/countUp/js/countUp.min.js',
