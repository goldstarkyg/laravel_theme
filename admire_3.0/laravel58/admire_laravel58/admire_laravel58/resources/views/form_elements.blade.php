...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('vendors/chosen/css/chosen.min.css')}}"/>
    ...
    <link rel="stylesheet" href="{{asset('vendors/multiselect/css/multi-select.css')}}"/>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('vendors/chosen/js/chosen.jquery.min.js')}}"></script>
    ...
    <script src="{{asset('vendors/multiselect/js/jquery.multi-select.js')}}"></script>
